package com.peihou.waterpurifer.bean;
...
public class BarChartManager {
    ...
    private void initLineChart() {
        //背景颜色
        mBarChart.setBackgroundColor(Color.parseColor("#44deff"));
        mBarChart.setGridBackgroundColor(Color.parseColor("#44deff"));
        mBarChart.setBorderColor(Color.WHITE);
        mBarChart.setDrawingCacheBackgroundColor(Color.WHITE);
        //网格
        ...
        leftAxis.setAxisLineColor(Color.parseColor("#44deff"));

        xAxis.setAxisLineColor(Color.parseColor("#44deff"));
